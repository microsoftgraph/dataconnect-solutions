...
class GroupPerWeekIdentity(@Id
  ...
  override def equals(that: Any): Boolean =
    that match {
      case ei: GroupPerWeekIdentity => (this eq ei) && hashCode == ei.hashCode && id == ei.id && version == ei.version
      case _ => false
    }
...
object GroupPerWeekIdentity {
  def apply(id: String, version: LocalDateTime): GroupPerWeekIdentity = new GroupPerWeekIdentity(id, version)
}
