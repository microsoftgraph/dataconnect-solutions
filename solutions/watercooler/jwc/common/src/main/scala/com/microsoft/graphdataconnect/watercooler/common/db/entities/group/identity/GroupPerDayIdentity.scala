...
class GroupPerDayIdentity(@Id
  ...
  override def equals(that: Any): Boolean =
    that match {
      case ei: GroupPerDayIdentity => (this eq ei) && hashCode == ei.hashCode && id == ei.id && version == ei.version
      case _ => false
    }
...
object GroupPerDayIdentity {
  def apply(id: String, version: LocalDateTime): GroupPerDayIdentity = new GroupPerDayIdentity(id, version)
}
