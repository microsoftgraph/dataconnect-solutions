...
> **Observation**: if you are on windows and you encounter issues running `./prepare_artifacts.sh` than it is mandatory
...
To build the jars without skipping the tests, navigate to `jwc` folder and
