...
def analyze_conversations(all_conversations):
    def analyze_per_partition(partition_data):
        ...
        text_analytics_client = TextAnalyticsClient(endpoint=azure_ai_endpoint,
...
def create_conversation_sentiment_info(analyzed_conversations):
    ...
    return analyzed_conversations.map(transform).toDF(
...
def create_conversation_entities_info(analyzed_conversations):
    ...
    return analyzed_conversations.flatMap(transform).toDF(
...
def main():
    ...
    write_df_to_sql(conversation_sentiment_info, "dbo.conversation_sentiment_info",
                    conversation_sentiment_info_sql_table_definition)
    ...
    write_df_to_sql(conversation_entities_info, "dbo.conversation_entities_info",
                    conversation_entities_info_sql_table_definition)
    ...
    write_df_to_sql(conversation_to_recipient_sentiment_info, "dbo.conversation_to_recipient_sentiment_info",
                    conversation_to_recipient_sentiment_info_sql_table_definition)
