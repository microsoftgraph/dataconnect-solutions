...
## Input data:
The source for the azure text analytics service is the content of the `dbo.augmented_emails` table.   
Sample data:   
![dbo_augmented_mails.png](../docs/analytics_notebook_imgs/dbo_augmented_mails.png)
