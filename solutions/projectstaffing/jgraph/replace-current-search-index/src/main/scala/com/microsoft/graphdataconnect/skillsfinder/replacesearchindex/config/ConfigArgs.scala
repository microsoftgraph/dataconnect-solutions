...
package com.microsoft.graphdataconnect.skillsfinder.replacesearchindex.config
    ...
    val argsParser = {
      ...
      OParser.sequence(
        opt[String]("application-id")
          ...
          .text("application id"),
        opt[String]("new-azure-search-index-name")
          .valueName("<string>")
          .action((string, currentConfig) => currentConfig.copy(newAzureSearchIndexName = Some(string)))
          .text("new azure search index name"),
...
case class ConfigArgs(newAzureSearchIndexName: Option[String] = None,
