...
- in Chrome:
    - open the ProjectStaffing UI of the development App Service in the browser
    ...
    - after the local application is started, open the local ProjectStaffing UI in the browser (localhost:7655)
