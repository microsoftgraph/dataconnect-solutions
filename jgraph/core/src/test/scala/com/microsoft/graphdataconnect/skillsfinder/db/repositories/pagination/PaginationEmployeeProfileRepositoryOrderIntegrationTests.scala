...
class PaginationEmployeeProfileRepositoryOrderIntegrationTests extends AbstractIntegrationTestBase {
  ...
  @Test
  def pagination_RecommendedOrder_NoEngDate_1(): Unit = {
    // Arrange
  ...
  @Test
  def pagination_RecommendedOrder_NoEngDate_2(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_RecommendedOrder_OneWithEngDate(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_RecommendedOrder_AllWithEngDate_1(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
    ...
    var hrDataProfile2: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile2.composedId = HRDataEmployeeIdentity("admin2@fake.com", version)
    hrDataProfile2.availableStartingFrom = "2021-11-11"
    hrDataProfile2 = hrDataEmployeeProfileRepository.save(hrDataProfile2)
  ...
  @Test
  def pagination_RecommendedOrder_AllWithEngDate_2(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_NoEngDate_1(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_NoEngDate_2(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_OneWithEngDate(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_AllWithEngDate_1(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_AllWithEngDate_2(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
  ...
  @Test
  def pagination_Order_byName(): Unit = {
    // Arrange
    val version = TimeUtils.oldestSqlDate
    var hrDataProfile1: HRDataEmployeeProfile = new HRDataEmployeeProfile()
    hrDataProfile1.composedId = HRDataEmployeeIdentity("admin1@fake.com", version)
    hrDataProfile1.availableStartingFrom = "2021-11-11"
    hrDataProfile1 = hrDataEmployeeProfileRepository.save(hrDataProfile1)
